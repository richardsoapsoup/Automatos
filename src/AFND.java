...
public class AFND {
    ...
    public AFND(Set<Estado> estados, Set<Character> alfabeto, Estado estadoInicial, Set<Estado> estadosFinais) {
    ...
    public void definirTransicao(Estado estadoOrigem, Character simbolo, Set<Estado> estadosDestino) {
